...
RUN git clone --recursive --depth=1 https://github.com/khs1994-php/khsci.git /root/khs1994-php/khsci \
    && cd /root/khs1994-php/khsci \
    && composer install -q \
    && composer update -q \
    && vendor/bin/phpunit
...
COPY --from=0 /root/khs1994-php/khsci /root/khs1994-php/khsci

RUN cd /root/khs1994-php/khsci \
